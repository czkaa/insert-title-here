<template>
  ...
  >
    ...
    >
      <div
        class="w-2.5 h-2/3 sm:h-3/4 bg-tertiary flex-shrink-0 mt-4 group-hover:bg-tertiary transition-all duration-500"
      />
      <div
        class="w-full h-full bg-tertiary rounded-md group-hover:bg-tertiary transition-all duration-500"
      >
        <div
          class="text-md transform rotate-90 origin-top-left mt-10 ml-3 filter-outline-xs"
        >
          <nobr>Subpage 1</nobr>
        </div>
      </div>
    ...
    >
      ...
      >
        <div
          class="text-md transform rotate-90 origin-top-left mt-10 ml-6 filter-outline-xs"
        >
          <nobr>Subpage 2</nobr>
        </div>
      </div>
